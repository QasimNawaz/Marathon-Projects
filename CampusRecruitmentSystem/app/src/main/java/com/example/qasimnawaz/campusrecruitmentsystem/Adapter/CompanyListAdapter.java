...
public class CompanyListAdapter extends ArrayAdapter<CompanyModule> implements View.OnClickListener{
    ...
    public CompanyListAdapter(ArrayList<CompanyModule> data, Context context) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.row_item_info:
                Snackbar.make(v, "Release date " +dataModel.getCmpName(), Snackbar.LENGTH_LONG)
...
//        viewHolder.info.setTag(position);
        ...
        viewHolder.txtEmail.setText(dataModel.getCmpEmail());
        viewHolder.txtVersion.setText(dataModel.getSmpEstablish());
        viewHolder.txtType.setText(dataModel.getCmpHR());
